...
jQuery(document).ready(function(NAD)
{
	...
	*/
    ...
    {
    	if(NAD('.grid_sorting_button').length)
    	{
    		NAD('.grid_sorting_button').click(function()
	    	{
		        ...
		        NAD('.grid_sorting_button.active').removeClass('active');
		        NAD(this).addClass('active');
		 
		        var selector = NAD(this).attr('data-filter');
	...
	*/
    ...
    function initSlider()
    {
    	if(NAD('.product_slider').length)
    	{
    		var slider1 = NAD('.product_slider');
    		...
    		if(NAD('.product_slider_nav_left').length)
    		{
    			NAD('.product_slider_nav_left').on('click', function()
    			{
    				slider1.trigger('prev.owl.carousel');
    			});
    		}

    		if(NAD('.product_slider_nav_right').length)
    		{
    			NAD('.product_slider_nav_right').on('click', function()
    			{
